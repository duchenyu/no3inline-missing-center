...
For $n\ge 33$, only rct4 solutions remain in the database, and \textbf{rct4 solutions invariably have the grid center as a circumcenter}. This is a group-theoretic necessity for the rct4 class: rct4 (and C$_4$) orbits on odd-$n$ grids have orbit size 4, forcing $\ge 4$ points per distance ring.
